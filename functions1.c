...
int print_unsigned_number(va_list args, char buffer[], int flags, int width, int precision, int size);
int print_octal_number(va_list args, char buffer[], int flags, int width, int precision, int size);
int print_hexadecimal_number(va_list args, char buffer[], int flags, int width, int precision, int size);
int print_uppercase_hexadecimal_number(va_list args, char buffer[], int flags, int width, int precision, int size);
